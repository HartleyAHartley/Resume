...
\name{Alex J.}{Hartley}
\address{28011601 East Hall, Gainesville, Florida}
\mobile{770-314-0110}
...
\letterenclosure{} % Any enclosures with the letter

\makecvfooter{\today}{Alex J. Hartleyk~~~·~~~Cover Letter}{} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
