...
\definecolor{awesome}{HTML}{FA4616} % Uncomment if you would like to specify your own color
...
\name{Alice}{Hartley}
%\address{3527 SW 20th Ave Apt 714, Gainesville, FL 32607}
\mobile{770-314-0110}

\email{alicehartleyhartley@gmail.com}
\homepage{www.alicehartley.com}
\github{HartleyAHartley}
\linkedin{HartleyAHartley}
%\skype{skypeid}
...
\makecvfooter{}{Alice Hartley~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
...
\input{cv-sections/involvement.tex}
